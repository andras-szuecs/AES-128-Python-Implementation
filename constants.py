...
]  # inverse Rijndael S-Box from Wikipedia
...
Matrix = [
    ...
    [1, 1, 2, 3],
    [3, 1, 1, 2]
]  # Matrix used for MixColumns from Wikipedia
...
inverseMatrix = [
    ...
    [13, 9, 14, 11],
    [11, 13, 9, 14]
]  # inverse Matrix used for MixColumns from Wikipedia
...
Rcon = [0x00,
        ...
        0x80000000,
        0x1b000000,
        0x36000000]  # Numbers used in RCon in keyschedule from Wikipedia
